  ...
  return (
    <section id="reference" className="reference">
      <div className="container flex">
        <div className="reference__info-block">
          <h2 className="reference__title">References</h2>
          <p className="reference__info">
            You can contact with me&nbsp;through various platforms to&nbsp;stay updated on&nbsp;my&nbsp;latest projects and get in&nbsp;touch for any inquiries. Feel free to&nbsp;reach out to&nbsp;me&nbsp;on&nbsp;VKontakte for social interactions and updates, or&nbsp;send me&nbsp;an&nbsp;email via Mail for more formal communication. If&nbsp;you prefer instant messaging, I&rsquo;m also available on&nbsp;Telegram where we&nbsp;can discuss potential collaborations or&nbsp;just have a&nbsp;chat. Additionally, you can check out my&nbsp;GitHub profile to&nbsp;see my&nbsp;code repositories and contributions to&nbsp;various projects. Each platform offers a&nbsp;unique way to&nbsp;connect and stay engaged, so&nbsp;choose the one that suits you best!
          </p>
        </div>
        <div className="reference__right-block flex">
        <ul className="reference__list list-reset flex">
                        <li className="reference__item">
                            <a href="https://vk.com/id384534054" id="vk-link" className="reference__link">
                        ...
                        <li className="reference__item">
                            <a href="https://github.com/Spectre113" id="gh-link" className="reference__link">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 96 96" width="80px" height="80px">
                        ...
                        <li className="reference__item">
                            <a href="https://mail.ru/" id="email" className="reference__link">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="80px" height="80px">
                                    <linearGradient id="SVGID_1_" x1="38.631" x2="9.369" y1="9.619" y2="38.881" gradientUnits="userSpaceOnUse">
                                        ...
                                        <stop offset=".033" stopColor="#6ae9fe"/><stop offset=".197" stopColor="#97f0fe"/>
                                        <stop offset=".362" stopColor="#bdf5ff"/><stop offset=".525" stopColor="#dafaff"/>
                                        <stop offset=".687" stopColor="#eefdff"/><stop offset=".846" stopColor="#fbfeff"/>
                                        <stop offset="1" stopColor="#fff"/>
                                    </linearGradient><path fill="url(#SVGID_1_)" d="M34.5,40.5h-21c-3.314,0-6-2.646-6-5.909V13.909C7.5,10.646,10.186,8,13.5,8h21c3.314,0,6,2.646,6,5.909v20.682	C40.5,37.854,37.814,40.5,34.5,40.5z"/><path fill="none" stroke="#10cfe3" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="3" d="M27.532,40.5H13.5c-3.314,0-6-2.686-6-6V21.809"/><path fill="none" stroke="#10cfe3" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="3" d="M7.5,16.064V13.5c0-3.314,2.686-6,6-6h21c3.314,0,6,2.686,6,6v21c0,3.314-2.686,6-6,6"/><path fill="none" stroke="#10cfe3" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="3" d="M23.383,31.516H13.5c-0.552,0-1-0.448-1-1V17.484c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1v13.032	c0,0.552-0.448,1-1,1h-4.862H23.383z"/><path fill="none" stroke="#10cfe3" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="3" d="M34.856,17.319l-9.022,7.347c-1.073,0.874-2.613,0.873-3.685-0.001l-4.381-3.573"/><line x1="19.824" x2="13.144" y1="24" y2="30.681" fill="none" stroke="#10cfe3" strokeMiterlimit="10" strokeWidth="3"/>
                                    <line x1="34.856" x2="28.166" y1="30.681" y2="24" fill="none" stroke="#10cfe3" strokeMiterlimit="10" strokeWidth="3"/>
                                </svg>
                            </a>
                        </li>
                        <li className="reference__item">
                            <a href="https://web.telegram.org/k/" id="tg-link" className="reference__link">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="80px" height="80px">
          ...
          <div className="reference__contact flex">
            <div className="reference__contact-item">
              <p className="reference__contact-info">Phone: +79193585809</p>
              <button className="reference-copy btn-reset" data-copy-text="+79193585809">Copy Phone</button>
            </div>
            <div className="reference__contact-item">
              <p className="reference__contact-info">Email: VTvolody626@mail.ru</p>
              <button className="reference-copy btn-reset" data-copy-text="VTvolody626@mail.ru">Copy Email</button>
            </div>
            <div className="reference__contact-item">
              <p className="reference__contact-info">Tg id: Spectre113</p>
              <button className="reference-copy btn-reset" data-copy-text="VTvolody626@mail.ru">Copy Tg</button>
            </div>
          </div>
        </div>
      </div>
